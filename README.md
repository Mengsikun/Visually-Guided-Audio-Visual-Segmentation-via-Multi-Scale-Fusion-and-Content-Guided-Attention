...
## 📖 Abstract
Audio-Visual Segmentation (AVS) aims to pixel-wise locate and segment sounding objects in videos driven by audio cues. However, current mainstream methods typically employ audio-centric Transformer frameworks... *(You can paste your full abstract here)*.
